 ...
 * **Lab Question 6 (10 points)**: How many files are in the `f2` directory (and its sub(sub)directories? Give the full path to each one (this includes the filename). 
